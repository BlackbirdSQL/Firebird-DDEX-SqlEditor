...
[Download BlackbirdSql DDEX Extension (Pre-release v9.1.0.72-beta)](https://github.com/BlackbirdSQL/Firebird-NETProvider-DDEX/releases/download/v9.1.0.72-beta/BlackbirdSql.VisualStudio.Ddex.vsix)
