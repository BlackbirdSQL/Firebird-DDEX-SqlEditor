...
* If you have a huge number of triggers then rendering of the triggers, or any other collection for that matter, in the SE may take some time. This may be normal behavior for the SE.
