# BlackbirdSQL DDEX 2.0 with SqlEditor Provider for Firebird 9.1.0.84 Beta
...
[Download BlackbirdSql DDEX with SqlEditor Extension (Pre-release v9.1.0.83-beta)](https://github.com/BlackbirdSQL/Firebird-DDEX-SqlEditor/releases/download/v9.1.0.83-beta/BlackbirdSql.VisualStudio.Ddex.vsix)
