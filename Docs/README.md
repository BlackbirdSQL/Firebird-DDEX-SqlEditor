...
[Download BlackbirdSql DDEX with SqlEditor Extension (Release v10.0.2.1)](https://github.com/BlackbirdSQL/Firebird-DDEX-SqlEditor/releases/download/v10.0.2.1/BlackbirdSql.VisualStudio.Ddex.vsix)
