...
[Download BlackbirdSql DDEX with SqlEditor Extension (Pre-release v10.0.1.4)](https://github.com/BlackbirdSQL/Firebird-DDEX-SqlEditor/releases/download/v10.0.1.4/BlackbirdSql.VisualStudio.Ddex.vsix)
