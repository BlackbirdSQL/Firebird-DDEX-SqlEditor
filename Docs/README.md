...
[Download BlackbirdSql DDEX with SqlEditor Extension (Pre-release v10.0.1.1)](https://github.com/BlackbirdSQL/Firebird-DDEX-SqlEditor/releases/download/v10.0.1.1-prerelease/BlackbirdSql.VisualStudio.Ddex.vsix)
