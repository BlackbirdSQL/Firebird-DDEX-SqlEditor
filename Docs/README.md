...
[Download BlackbirdSql DDEX with SqlEditor Extension (Pre-release v9.1.0.91)](https://github.com/BlackbirdSQL/Firebird-DDEX-SqlEditor/releases/download/v9.1.0.91-prerelease/BlackbirdSql.VisualStudio.Ddex.vsix)
