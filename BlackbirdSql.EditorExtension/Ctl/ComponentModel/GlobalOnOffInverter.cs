...
public class GlobalOnOffInverter :  AbstractBoolConverter
{

	public override string LiteralFalseResource => "GlobalizedLiteralOn";
	public override string LiteralTrueResource => "GlobalizedLiteralOff";
