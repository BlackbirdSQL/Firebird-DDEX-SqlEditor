...
public class RangeConverter : TypeConverter
{
	...
	{
		// Evs.Trace("CanConvertFrom: " + context.PropertyDescriptor.Name);
	...
	{
		// Evs.Trace("ConvertFrom: " + context.PropertyDescriptor.Name);
		RegisterModel(context);
	...
	public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
	{
		...
		// Evs.Trace("ConvertTo: " + context.PropertyDescriptor.Name);
