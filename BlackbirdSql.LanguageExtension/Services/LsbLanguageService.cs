...
public class LsbLanguageService : LanguageService, IVsLanguageBlock
{
	public LsbLanguageService(object site) : base()
	{
		SetSite(site);
	...
	public class CustomViewFilter : ViewFilter
	{
		...
		public CustomViewFilter(LsbLanguageService service, CodeWindowManager mgr, IVsTextView view)
			: base(mgr, view)
		{
	...
	/// </summary>
	private bool OverrideError(string script, Error error)
	{
