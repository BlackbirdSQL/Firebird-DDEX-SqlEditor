...
// =========================================================================================================
//
//											LsbDatabasePermission Class
//
/// <summary>
/// Impersonation of an SQL Server Smo DatabasePermission for providing metadata.
/// </summary>
// =========================================================================================================
internal class LsbDatabasePermission : IDatabasePermission, IMetadataObject
{

	// ---------------------------------------------------------------------------------
	#region Constructors / Destructors - LsbDatabasePermission
	// ---------------------------------------------------------------------------------


	public LsbDatabasePermission(IDatabasePrincipal databasePrincipal, PermissionInfo permissionInfo, DatabasePermissionType permissionType, Microsoft.SqlServer.Management.SqlParser.Metadata.PermissionState permissionState, IDatabasePrincipal grantor)
	{
	...
	// =========================================================================================================
	#region Fields - LsbDatabasePermission
	// =========================================================================================================
	...
	// =========================================================================================================
	#region Property accessors - LsbDatabasePermission
	// =========================================================================================================
	...
	// =========================================================================================================
	#region Methods - LsbDatabasePermission
	// =========================================================================================================
