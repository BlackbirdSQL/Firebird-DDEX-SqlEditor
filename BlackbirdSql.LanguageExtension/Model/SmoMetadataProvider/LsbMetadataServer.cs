...
// =========================================================================================================
//
//											LsbMetadataServer Class
//
/// <summary>
/// The connection impersonating an SQL Server Smo Server for providing metadata.
/// </summary>
// =========================================================================================================
internal class LsbMetadataServer : AbstractDatabaseObject, IServer, IDatabaseObject, IMetadataObject
{

	// ---------------------------------------------------------------------------------
	#region Constructors / Destructors - LsbMetadataServer
	// ---------------------------------------------------------------------------------


	public LsbMetadataServer(LsbSmoServer smoMetadataObject, bool isConnected)
	{
		...
		// {
			...
			if (database != null)
			{
				...
				{
					databaseCollection.Add(new LsbDatabase(database2, this));
				}
			}
			else
			{
				...
				databaseCollection.Add(new LsbDatabase(smoMetadataObject3, this));
			}
	...
	// =========================================================================================================
	#region Constants - LsbMetadataServer
	// =========================================================================================================
	...
	// =========================================================================================================
	#region Fields - LsbMetadataServer
	// =========================================================================================================
	...
	// =========================================================================================================
	#region Property accessors - LsbMetadataServer
	// =========================================================================================================
	...
	// =========================================================================================================
	#region Methods - LsbMetadataServer
	// =========================================================================================================
	...
	public void RefreshDatabaseList()
	{
		...
		foreach (LsbDatabase database7 in (IMetadataCollection<LsbDatabase>)Databases)
		{
			...
			if (database5 != null)
			{
				...
				database4.Refresh();
				databaseCollection.Add(new LsbDatabase(database4, this));
			}
		}
		...
		if (databases.Count > databaseCollection.Count)
		{
			foreach (Microsoft.SqlServer.Management.Smo.Database item2 in databases)
			{
				...
				{
					databaseCollection.Add(new LsbDatabase(item2, this));
				}
			}
		}
		SetDatabases(databaseCollection);
	...
	private void SetDatabases(IMetadataCollection<IDatabase> collection)
	{
		...
		if (database == null)
		{
			database = LsbMetadataFactory.Instance.Database.CreateEmptyDatabase(this, C_MasterDatabaseName, _CollationInfo, isSystemObject: true);
	...
	// =========================================================================================================
	#region									Nested types - LsbMetadataServer
	// =========================================================================================================
	...
	{
		protected readonly LsbMetadataServer m_server;

		protected override LsbMetadataServer Server => m_server;

		public CollectionHelperI(LsbMetadataServer server)
		{
			Diag.ThrowIfInstanceNull(server, typeof(LsbMetadataServer));
		...
		{
			return m_server._CollationInfo;
		}
	}
	...
	{
		public CredentialCollectionHelperI(LsbMetadataServer server)
			: base(server)
		{
		}
		...
		{
			return new SmoCollectionMetadataListI<Microsoft.SqlServer.Management.Smo.Credential>(m_server, m_server._SmoMetadataObject.Credentials);
		}
		...
		{
			return new Microsoft.SqlServer.Management.SmoMetadataProvider.Credential(smoObject, m_server);
		}
	}
	...
	{
		public LoginCollectionHelperI(LsbMetadataServer server)
			: base(server)
		{
		}
		...
		{
			return new SmoCollectionMetadataListI<Microsoft.SqlServer.Management.Smo.Login>(m_server, m_server._SmoMetadataObject.Logins);
		}
		...
		{
			return Microsoft.SqlServer.Management.SmoMetadataProvider.Login.CreateLogin(smoObject, m_server);
		}
	}
	...
	// ---------------------------------------------------------------------------------
	/// <summary>
	/// Original class: TriggerCollectionHelperI.
	/// </summary>
	// ---------------------------------------------------------------------------------
	...
	{
		public TriggerCollectionHelperI(LsbMetadataServer server)
			: base(server)
		{
		}
		...
		{
			return new SmoCollectionMetadataListI<Microsoft.SqlServer.Management.Smo.ServerDdlTrigger>(m_server, m_server._SmoMetadataObject.Triggers);
		}
		...
		{
			return new Microsoft.SqlServer.Management.SmoMetadataProvider.ServerDdlTrigger(smoObject, m_server);
		}
	}
