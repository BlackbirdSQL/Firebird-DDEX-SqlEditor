...
// =========================================================================================================
//
//											LsbDatabasePrincipal Class
//
/// <summary>
/// Impersonation of an SQL Server Smo DatabasePrincipal for providing metadata.
/// </summary>
// =========================================================================================================
internal abstract class LsbDatabasePrincipal<S> : LsbDatabaseOwnedObject<S>, IDatabasePrincipal, IDatabaseOwnedObject, IDatabaseObject, IMetadataObject where S : NamedSmoObject
{

	// ---------------------------------------------------------------------------------
	#region Constructors / Destructors - LsbDatabasePrincipal
	// ---------------------------------------------------------------------------------


	protected LsbDatabasePrincipal(S smoMetadataObject, LsbDatabase parent)
		: base(smoMetadataObject, parent)
	{
	}

	static LsbDatabasePrincipal()
	{
	...
	// =========================================================================================================
	#region Fields - LsbDatabasePrincipal
	// =========================================================================================================
	...
	// =========================================================================================================
	#region Property accessors - LsbDatabasePrincipal
	// =========================================================================================================
	...
	// =========================================================================================================
	#region Methods - LsbDatabasePrincipal
	// =========================================================================================================
	...
	{
		ObjectPermissionInfo[] array = base.Parent.SmoObject.EnumObjectPermissions(m_smoMetadataObject.Name);
		IEnumerable<DatabasePermissionInfo> enumerable = base.Parent.SmoObject.EnumDatabasePermissions(m_smoMetadataObject.Name);
		...
		foreach (ObjectPermissionInfo item3 in (IEnumerable<ObjectPermissionInfo>)array)
		{
			...
			{
				IDatabasePermission item = new LsbDatabasePermission(this, item3, permissionType, permissionState, null);
		...
		foreach (DatabasePermissionInfo item4 in enumerable)
		{
			...
			{
				IDatabasePermission item2 = new LsbDatabasePermission(this, item4, permissionType2, permissionState2, null);
