...
// =========================================================================================================
//
//											AbstractSmoMetaMetadataProvider Class
//
/// <summary>
/// Language service IMetadataProvider implementation.
/// </summary>
// =========================================================================================================
public abstract class AbstractSmoMetaMetadataProvider : AbstractMetadataProvider
{
	...
	private AbstractSmoMetaMetadataProvider(/* Microsoft.SqlServer.Management.Smo.Server */ LsbSmoServer server, bool isConnected)
	...
	// =========================================================================================================
	#region Fields - AbstractSmoMetaMetadataProvider
	// =========================================================================================================
	...
	private readonly SmoMetaServer _Server;
	...
	// =========================================================================================================
	#region Property accessors - AbstractSmoMetaMetadataProvider
	// =========================================================================================================
	...
	// =========================================================================================================
	#region Methods - AbstractSmoMetaMetadataProvider
	// =========================================================================================================


	public static AbstractSmoMetaMetadataProvider CreateConnectedProvider(IDbConnection connection)
	{
		return ConnectedMetadataProviderI.Create(connection);
	}

	public static AbstractSmoMetaMetadataProvider CreateConnectedProvider(IDbConnection connection, int refreshDbListMillisecond)
	{
		return ConnectedMetadataProviderI.Create(connection, refreshDbListMillisecond);
	}

	public static AbstractSmoMetaMetadataProvider CreateDisconnectedProvider(/* Microsoft.SqlServer.Management.Smo.Server */ LsbSmoServer server)
	{
	...
	// =========================================================================================================
	#region								Nested types - AbstractSmoMetaMetadataProvider
	// =========================================================================================================
	...
	/// </summary>
	// ---------------------------------------------------------------------------------
	private sealed class ConnectedMetadataProviderI : AbstractSmoMetaMetadataProvider
	{
	...
	/// </summary>
	// ---------------------------------------------------------------------------------
	private sealed class DisconnectedLsbMetadataProvider : AbstractSmoMetaMetadataProvider
	{
