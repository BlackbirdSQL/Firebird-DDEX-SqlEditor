...
using EnStatisticSpecialAction = BlackbirdSql.Common.Controls.ResultsPanels.StatisticsPropertySet.EnStatisticSpecialAction;
...
public class StatisticsPanel : AbstractGridResultsPanel, IOleCommandTarget
{
	...
	{
		if (m.Msg == Core.Native.WM_CONTEXTMENU)
		{
