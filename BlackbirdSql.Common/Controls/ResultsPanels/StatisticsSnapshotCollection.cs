...
public class StatisticsSnapshotCollection : CollectionBase
{
	...
	public void LoadStatisticsSnapshotBase(QueryManager qryMgr)
	{
		try
		{
			...
			QESQLQueryDataEventArgs args = new(qryMgr.LiveSettings.ExecutionType, Sys.EnSqlStatementAction.Inactive,
				qryMgr.LiveSettings.EditorResultsOutputMode, qryMgr.IsWithActualPlan, qryMgr.IsWithClientStats, 0, 0, 0,
				qryMgr.QueryExecutionStartTime, DateTime.Now);
