...
namespace BlackbirdSql.Common.Controls.PropertiesWindow
{
	public class SqlConnectionPropertiesDisplay : SqlEditorPropertiesBase, IPropertyWindowQueryExecutorInitialize
	{
		...
		[GlobalizedCategory("PropertyWindowConnectionDetails")]
		[GlobalizedDescription("PropertyWindowSpidDescription")]
		[GlobalizedDisplayName("PropertyWindowSpidDisplayName")]
		public string Spid => Strategy.Spid;
		...
		public string StartTime
		{
			get
			{
				if (QueryExecutor == null || !QueryExecutor.QueryExecutionStartTime.HasValue)
				{
					return string.Empty;
				}

				return FormatTime(QueryExecutor.QueryExecutionStartTime.Value);
			}
		}
		...
		public string FinishTime
		{
			get
			{
				if (QueryExecutor == null || !QueryExecutor.QueryExecutionEndTime.HasValue)
				{
					return string.Empty;
				}

				return FormatTime(QueryExecutor.QueryExecutionEndTime.Value);
			}
		}
		...
		public string ElapsedTime
		{
			get
			{
				if (QueryExecutor == null || !QueryExecutor.QueryExecutionEndTime.HasValue || !QueryExecutor.QueryExecutionStartTime.HasValue)
				{
					return string.Empty;
				}

				return GetElapsedTime(QueryExecutor.QueryExecutionStartTime.Value, QueryExecutor.QueryExecutionEndTime.Value);
			}
		}
		...
		public string TotalRowsReturned
		{
			get
			{
				...
				{
					return QueryExecutor.RowsAffected.ToString(CultureInfo.CurrentCulture);
				}
		...
		public SqlConnectionPropertiesDisplay(SqlConnectionStrategy connectionStrategy)
		{
		...
		public void Initialize(QueryExecutor queryExecutor)
		{
		...
		{
			UIConnectionInfo connectionInfo = QueryExecutor.ConnectionStrategy.UiConnectionInfo;
			string result = string.Empty;
