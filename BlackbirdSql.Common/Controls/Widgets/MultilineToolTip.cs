...
public class MultilineToolTip : ToolTip
{
	...
	public MultilineToolTip()
	{
		...
		base.InitialDelay = 400;
		timer = new Timer();
		timer.Tick += OnTimerTick;
		base.Popup += OnToolTipPopup;
		base.Draw += OnToolTipDraw;
	}
	...
	public new void RemoveAll()
	{
		...
		controlDataList.RemoveAll((ControlData data) => true);
	}
	...
	protected virtual void DrawContent(DrawToolTipEventArgs e)
	{
		...
		e.Graphics.DrawString(CurrentText, Font, new SolidBrush(base.ForeColor), rectangle, stringFormat);
	}
	...
	{
		timer.Interval = base.InitialDelay;
		timer.Start();
	}
