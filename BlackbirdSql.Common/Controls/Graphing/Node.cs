...
public class Node : Microsoft.AnalysisServices.Graphing.Node
{
	...
	public class ChildrenCollection : NodeCollection<BlackbirdSql.Common.Controls.Graphing.Node>
	{
		public override bool IsReadOnly => false;

		public ChildrenCollection(BlackbirdSql.Common.Controls.Graphing.Node node)
			: base(node)
		{
		}

		public override void Add(BlackbirdSql.Common.Controls.Graphing.Node child)
		{
			BlackbirdSql.Common.Controls.Graphing.Edge iedge = new BlackbirdSql.Common.Controls.Graphing.Edge(base.Owner, child);
	...
	public double Cost
	{
		get
		{
			...
			{
				cost = SubtreeCost;
				foreach (BlackbirdSql.Common.Controls.Graphing.Node child in Children)
				{
	...
	public BlackbirdSql.Common.Controls.Graphing.Node Parent
	{
		get
		{
			...
			if (parents.MoveNext())
			{
				return parents.Current as BlackbirdSql.Common.Controls.Graphing.Node;
			}
			return null;
		}
	}

	public BlackbirdSql.Common.Controls.Graphing.Node Root => Graph.Nodes[0] as BlackbirdSql.Common.Controls.Graphing.Node;
	...
	public bool IsLogicallyEquivalentTo(BlackbirdSql.Common.Controls.Graphing.Node nodeToCompare, bool ignoreDatabaseName)
	{
