...
public class NodeDisplay : Microsoft.AnalysisServices.Graphing.NodeDisplay, IRenderable, ICustomTypeDescriptor
{
	...
	public NodeDisplay Parent
	{
		get
		{
			...
			if (parents.MoveNext())
			{
				return parents.Current as BlackbirdSql.Common.Controls.Graphing.NodeDisplay;
			}
			return null;
		}
	}
	...
	public new BlackbirdSql.Common.Controls.Graphing.Node NodeOriginal => (BlackbirdSql.Common.Controls.Graphing.Node)base.NodeOriginal;
	...
	private Image ParallelProcessingImage
	{
		get
		{
			parallelProcessingImage ??= new Icon(typeof(BlackbirdSql.Common.Controls.Graphing.NodeDisplay), "ParallelProcess.ico").ToBitmap();
	...
	private Image WarningImage
	{
		get
		{
			warningImage ??= new Icon(typeof(BlackbirdSql.Common.Controls.Graphing.NodeDisplay), "Warning.ico").ToBitmap();
			return warningImage;
		}
	}
	...
	private bool IsParentHierarchyTreeStructure(BlackbirdSql.Common.Controls.Graphing.NodeDisplay node)
	{
		while (node != null)
		{
	...
	internal int InitializeEdges()
	{
		...
		{
			BlackbirdSql.Common.Controls.Graphing.EdgeDisplay edgeDisplay = edgesRelated.Current as BlackbirdSql.Common.Controls.Graphing.EdgeDisplay;
		...
		if (Children.Count > 1)
		{
			...
			while (edgesRelated.MoveNext())
			{
				BlackbirdSql.Common.Controls.Graphing.EdgeDisplay edgeDisplay2 = edgesRelated.Current as BlackbirdSql.Common.Controls.Graphing.EdgeDisplay;
