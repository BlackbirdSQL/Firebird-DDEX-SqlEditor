...
public class Splitter : Control
{
	...
	public int SplitPosition
	{
		...
		set
		{
			...
			OnSplitterMoved(new SplitterEventArgs(base.Left, base.Top, base.Left + bounds.Width / 2, base.Top + bounds.Height / 2));
		}
	}
	...
	public event SplitterEventHandler SplitterMovingEvent
	{
		add
		{
			base.Events.AddHandler(S_EVENT_MOVING, value);
		}
		remove
		{
			base.Events.RemoveHandler(S_EVENT_MOVING, value);
		}
	}
	...
	public event SplitterEventHandler SplitterMovedEvent
	{
		add
		{
			base.Events.AddHandler(S_EVENT_MOVED, value);
		}
		remove
		{
			base.Events.RemoveHandler(S_EVENT_MOVED, value);
		}
	}
	...
	protected override void OnMouseCaptureChanged(EventArgs e)
	{
		...
		if (!base.Capture && _SplitTarget != null)
		{
			SplitEnd(accept: false);
		}
	}
	...
	{
		((SplitterEventHandler)base.Events[S_EVENT_MOVING])?.Invoke(this, sevent);
		if (_SplitTarget != null)
		{
	...
	{
		((SplitterEventHandler)base.Events[S_EVENT_MOVED])?.Invoke(this, sevent);
		if (_SplitTarget != null)
		{
			SplitMove(sevent.SplitX, sevent.SplitY);
		}
	...
	{
		int num = GetSplitSize(x - base.Left + _Anchor.X, y - base.Top + _Anchor.Y);
		if (_SplitSize != num)
		{
			_SplitSize = num;
