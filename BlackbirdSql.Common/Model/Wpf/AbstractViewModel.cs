...
public abstract class AbstractViewModel : AbstractDispatcherConnection
{
	...
	public AbstractViewModel ParentViewModel
	{
		get { return (AbstractViewModel)GetProperty(C_KeyParentViewModel); }
		set { SetProperty(C_KeyParentViewModel, value); }
	}



	public AbstractViewModel(Dispatcher dispatcher, IBEventsChannel channel, AbstractViewModel parentViewModel, AbstractViewModel rhs)
	...
	public AbstractViewModel(Dispatcher dispatcher, IBEventsChannel channel, AbstractViewModel parentViewModel = null)
		: this(dispatcher, channel, parentViewModel, null)
	{
	}

	public AbstractViewModel(IBEventsChannel channel, AbstractViewModel parentViewModel = null)
		: this(Dispatcher.CurrentDispatcher, channel, parentViewModel, null)
	{
	}

	public AbstractViewModel(AbstractViewModel parentViewModel, AbstractViewModel rhs) : this(Dispatcher.CurrentDispatcher, null, parentViewModel, rhs)
	{
	}

	public AbstractViewModel(AbstractViewModel parentViewModel = null) : this(Dispatcher.CurrentDispatcher, null, parentViewModel, null)
	{
	}
