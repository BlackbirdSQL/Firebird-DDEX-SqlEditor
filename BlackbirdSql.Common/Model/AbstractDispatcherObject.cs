...
// =========================================================================================================
//									AbstractDispatcherObject Class
//
/// <summary>
/// Merges SqlServer's NotifyPropertyChangedDispatcherConnection into the
/// <see cref="AbstractPropertyAgent"/> universal class.
/// </summary>
// =========================================================================================================
public class AbstractDispatcherObject : AbstractPropertyAgent
{

	// ---------------------------------------------------------------------------------
	#region Variables - AbstractDispatcherObject
	// ---------------------------------------------------------------------------------
	...
	// =========================================================================================================
	#region Property Accessors - AbstractDispatcherObject
	// =========================================================================================================
	...
	// =========================================================================================================
	#region Constructors / Destructors - AbstractDispatcherObject
	// =========================================================================================================
	...
	/// Universal .ctor
	/// </summary>
	public AbstractDispatcherObject(Dispatcher dispatcher, IBEventsChannel channel,
		AbstractDispatcherObject rhs, bool generateNewId) : base(channel, rhs, generateNewId)
	{
	...
	public AbstractDispatcherObject(IBEventsChannel channel, AbstractDispatcherObject rhs, bool generateNewId = true)
	: this(Dispatcher.CurrentDispatcher, channel, rhs, generateNewId)
	{
	}

	public AbstractDispatcherObject(Dispatcher dispatcher, AbstractDispatcherObject rhs, bool generateNewId = true)
		: this(dispatcher, null, rhs, generateNewId)
	{
	}

	public AbstractDispatcherObject(AbstractDispatcherObject rhs, bool generateNewId = true)
	: this(Dispatcher.CurrentDispatcher, null, rhs, generateNewId)
	{
	}


	public AbstractDispatcherObject() : this(Dispatcher.CurrentDispatcher, null, null, true)
	{
	}
	...
	// =========================================================================================================
	#region Methods - AbstractDispatcherObject
	// =========================================================================================================
	...
	{
		NotImplementedException ex = new("AbstractDispatcherObject::Copy");
		Diag.Dug(ex);
		throw ex;
	}
	...
	#endregion Methods - AbstractDispatcherObject
}
