...
/// </summary>
// =========================================================================================================
public class AbstractDispatcherAgent : AbstractPropertyAgent
{
	...
	// =========================================================================================================
	#region Property Accessors - AbstractDispatcherAgent
	// =========================================================================================================
	...
	// =========================================================================================================
	#region Constructors / Destructors - AbstractDispatcherAgent
	// =========================================================================================================
	...
	/// Universal .ctor
	/// </summary>
	public AbstractDispatcherAgent(Dispatcher dispatcher, IBEventsChannel channel,
		AbstractDispatcherAgent rhs, bool generateNewId) : base(channel, rhs, generateNewId)
	{
	...
	public AbstractDispatcherAgent(IBEventsChannel channel, AbstractDispatcherAgent rhs, bool generateNewId = true)
	: this(Dispatcher.CurrentDispatcher, channel, rhs, generateNewId)
	{
	}

	public AbstractDispatcherAgent(Dispatcher dispatcher, AbstractDispatcherAgent rhs, bool generateNewId = true)
		: this(dispatcher, null, rhs, generateNewId)
	{
	}

	public AbstractDispatcherAgent(AbstractDispatcherAgent rhs, bool generateNewId = true)
	: this(Dispatcher.CurrentDispatcher, null, rhs, generateNewId)
	{
	}


	public AbstractDispatcherAgent() : this(Dispatcher.CurrentDispatcher, null, null, true)
	{
	}
	...
	// =========================================================================================================
	#region Methods - AbstractDispatcherAgent
	// =========================================================================================================
...
#pragma warning restore VSTHRD110 // Observe result of async calls
	...
	{
		NotImplementedException ex = new("AbstractDispatcherAgent::Copy");
		Diag.Dug(ex);
		throw ex;
	}
	...
	#endregion Methods - AbstractDispatcherAgent
}
