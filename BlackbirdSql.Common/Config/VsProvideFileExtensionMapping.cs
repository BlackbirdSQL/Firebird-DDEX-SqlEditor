...
class VsProvideFileExtensionMapping : RegistrationAttribute
{
	...
	public VsProvideFileExtensionMapping(Type factoryType, string defaultName, short nameResourceID, int sortPriority = 0)
	{
