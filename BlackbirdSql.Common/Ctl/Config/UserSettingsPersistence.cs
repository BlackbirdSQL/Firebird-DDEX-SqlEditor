...
public sealed class UserSettingsPersistence : IBUserSettingsPersistence, IBUserSettings, ICloneable
{
	...
	private IBGeneralSettings _generalSettings = new GeneralSettings();

	private IBEditorTabAndStatusBarSettings _statusBarSettings = new EditorTabAndStatusBarSettings();

	private IBQueryExecutionSettings _executionSettings = new ExecutionSettings();

	private IBQueryExecutionResultsSettings _resultsSettings = new ExecutionResultsSettings();

	private IBEditorContextSettings _editorContextSettings = new EditorContextSettings();

	public IBGeneralSettings General
	{
		get
		{
	...
	public IBEditorTabAndStatusBarSettings StatusBar
	{
		get
		{
	...
	public IBQueryExecutionSettings Execution
	{
		get
		{
	...
	public IBQueryExecutionResultsSettings ExecutionResults
	{
		get
		{
	...
	public IBEditorContextSettings EditorContext
	{
		get
		{
	...
	public void Save(IBUserSettings settings)
	{
	...
	public object Clone()
	{
		IBUserSettings obj = MemberwiseClone() as IBUserSettings;
		obj.General = _generalSettings.Clone() as IBGeneralSettings;
		obj.Execution = _executionSettings.Clone() as IBQueryExecutionSettings;
		obj.ExecutionResults = _resultsSettings.Clone() as IBQueryExecutionResultsSettings;
		obj.StatusBar = _statusBarSettings.Clone() as IBEditorTabAndStatusBarSettings;
		obj.EditorContext = _editorContextSettings.Clone() as IBEditorContextSettings;
		return obj;
	}
