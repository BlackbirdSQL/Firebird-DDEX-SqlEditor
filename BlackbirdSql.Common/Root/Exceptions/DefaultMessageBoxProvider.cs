...
public class DefaultMessageBoxProvider : IMessageBoxProvider
{
	...
	DialogResult IMessageBoxProvider.ShowMessage(Exception e, string caption, EnExceptionMessageBoxButtons buttons, EnExceptionMessageBoxSymbol symbol, IWin32Window owner)
	{
	...
	DialogResult IMessageBoxProvider.ShowMessage(string text, string caption, EnExceptionMessageBoxButtons buttons, EnExceptionMessageBoxSymbol symbol, IWin32Window owner)
	{
		if (marshallingControl.InvokeRequired)
		{
