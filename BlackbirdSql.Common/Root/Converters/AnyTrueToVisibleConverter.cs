...
// Microsoft.SqlServer.ConnectionDlg.UI.WPF.Converters.AnyTrueToVisibleConverter
using System;
...
public class AnyTrueToVisibleConverter : IMultiValueConverter
{
	public virtual object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
	{
		...
		return ConverterHelper.GetConditionalVisibility((bool)new IsAnyTrueConverter().Convert(values, typeof(bool), parameter, culture), parameter, ignoreInvert: true);
	}
