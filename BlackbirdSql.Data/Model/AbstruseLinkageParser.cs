...
internal abstract class AbstruseLinkageParser : IBsNativeDbLinkageParser, IDisposable
{
	...
	protected virtual void BuildTriggerTable()
	{
		_DslParser = null;
	}
	...
	public abstract DataTable GetSequenceSchema(string[] restrictions);

	public abstract DataTable GetTriggerSchema(string[] restrictions, int systemFlag, int identityFlag);

	public abstract DataRow LocateIdentityTrigger(object objTable, object objField);
