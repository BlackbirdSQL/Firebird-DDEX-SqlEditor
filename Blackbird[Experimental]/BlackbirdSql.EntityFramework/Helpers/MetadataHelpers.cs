...
#if EF6 || NET
namespace BlackbirdSql.Data.Entity.Helpers;
#else
namespace BlackbirdSql.Data.Helpers;
#endif
...
internal static class MetadataHelpers
{
	...
	internal static PrimitiveTypeKind GetPrimitiveTypeKind(TypeUsage type)
	{
		if (!TryGetPrimitiveTypeKind(type, out var returnValue))
		{
			...
			Diag.Dug(true, "Cannot create parameter of non-primitive type");
	...
	{
		var tableName = TryGetValueForMetadataProperty<string>(entitySetBase, "Table");
