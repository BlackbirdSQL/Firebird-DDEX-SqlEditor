...
public class FbDateTimeTypeMapping : DateTimeTypeMapping
{
	...
	public FbDateTimeTypeMapping(string storeType, DslDbType fbDbType)
		: base(storeType)
	{
		_fbDbType = fbDbType;
	}

	protected FbDateTimeTypeMapping(RelationalTypeMappingParameters parameters, DslDbType fbDbType)
		: base(parameters)
	{
		_fbDbType = fbDbType;
	}
