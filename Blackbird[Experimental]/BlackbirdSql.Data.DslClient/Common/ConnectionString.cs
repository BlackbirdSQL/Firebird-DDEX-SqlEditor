...
internal sealed class ConnectionString
{
	...
	public ServerType ServerType => GetServerType(DefaultKeyServerType, _options.TryGetValue);
	...
	public WireCrypt WireCrypt => GetWireCrypt(DefaultKeyWireCrypt, _options.TryGetValue);
						...
						if (Synonyms.TryGetValue(values[0], out var key))
						{
							switch (key)
							{
								case DefaultKeyServerType:
									_options[key] = ParseEnum<ServerType>(values[1], DefaultKeyServerType);
									break;
								...
								case DefaultKeyWireCrypt:
									_options[key] = ParseEnum<WireCrypt>(values[1], DefaultKeyWireCrypt);
									break;
								default:
