...
internal static class TypeHelper
{
	...
	public static DslDbType GetFbDataTypeFromType(Type type)
	{
		if (type.IsEnum)
		{
		...
		{
			return DslDbType.Char;
		}
		else if (type == typeof(System.Boolean))
		{
			return DslDbType.Boolean;
		}
		...
		{
			Diag.Dug(true, $"Unknown type: {type}.");
	...
	public static DbDataType GetDbDataTypeFromFbDbType(DslDbType type)
	{
	...
	public static FbZonedDateTime CreateZonedDateTime(DateTime dateTime, ushort tzId, short? offset)
	{
		...
		{
			Diag.Dug(true, "Unknown time zone ID.");
