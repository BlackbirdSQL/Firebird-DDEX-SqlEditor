...
namespace BlackbirdSql.Data.Client.Managed.Version10;
...
internal class GdsDatabase : DatabaseBase
{
	...
	{
		Diag.Dug(true, "Trusted Auth isn't supported on < FB2.1.");
	...
	{
		Diag.Dug(true, "Cancel Operation isn't supported on < FB2.5.");
