...
public sealed class DslDataAdapter : DbDataAdapter, ICloneable
{
	...
	public event EventHandler<DslRowUpdatedEventArgs> RowUpdated
	{
		add
		{
	...
	public event EventHandler<DslRowUpdatingEventArgs> RowUpdating
	{
		add
		{
	...
	[Category("Fill")]
	[DefaultValue(null)]
	public new DslCommand SelectCommand
	{
		get { return (DslCommand)base.SelectCommand; }
		set { base.SelectCommand = value; }
	}

	[Category("Update")]
	[DefaultValue(null)]
	public new DslCommand InsertCommand
	{
		get { return (DslCommand)base.InsertCommand; }
		set { base.InsertCommand = value; }
	}

	[Category("Update")]
	[DefaultValue(null)]
	public new DslCommand UpdateCommand
	{
		get { return (DslCommand)base.UpdateCommand; }
		set { base.UpdateCommand = value; }
	}

	[Category("Update")]
	[DefaultValue(null)]
	public new DslCommand DeleteCommand
	{
		get { return (DslCommand)base.DeleteCommand; }
	...
	public DslDataAdapter()
		: base()
	{
	}

	public DslDataAdapter(DslCommand selectCommand)
		: base()
	{
		SelectCommand = selectCommand;
	}

	public DslDataAdapter(string selectCommandText, string selectConnectionString)
		: this(selectCommandText, new DslConnection(selectConnectionString))
	{
	}

	public DslDataAdapter(string selectCommandText, DslConnection selectConnection)
		: base()
	{
		SelectCommand = new DslCommand(selectCommandText, selectConnection);
	...
	{
		return new DslRowUpdatingEventArgs(dataRow, command, statementType, tableMapping);
	}
	...
	protected override RowUpdatedEventArgs CreateRowUpdatedEvent(
		...
		DataTableMapping tableMapping)
	{
		return new DslRowUpdatedEventArgs(dataRow, command, statementType, tableMapping);
	}

	protected override void OnRowUpdating(RowUpdatingEventArgs value)
	{
		EventHandler<DslRowUpdatingEventArgs> handler = null;

		handler = (EventHandler<DslRowUpdatingEventArgs>)base.Events[EventRowUpdating];

		if ((null != handler) &&
			(value is DslRowUpdatingEventArgs) &&
			(value != null))
		{
			handler(this, (DslRowUpdatingEventArgs)value);
		}
	}

	protected override void OnRowUpdated(RowUpdatedEventArgs value)
	{
		EventHandler<DslRowUpdatedEventArgs> handler = null;

		handler = (EventHandler<DslRowUpdatedEventArgs>)base.Events[EventRowUpdated];

		if ((handler != null) &&
			(value is DslRowUpdatedEventArgs) &&
			(value != null))
		{
			handler(this, (DslRowUpdatedEventArgs)value);
		}
	}
		...
		foreach (var row in dataRows)
		{
			...
			try
			{
				...
				else if (updatingArgs.Status == UpdateStatus.ErrorsOccurred)
				{
					...
					{
						Diag.Dug(true, "RowUpdatingEvent: Errors occurred; no additional information is available.");
				...
				else if (updatingArgs.Status == UpdateStatus.Continue)
				{
					...
					if (command == null)
					{
						 ...
						 */
						Diag.Dug(true, CreateExceptionMessage(statementType));
					...
					if (rowsAffected == 0)
					{
						DBConcurrencyException ex = new DBConcurrencyException(new DBConcurrencyException().Message, null, new DataRow[] { row });
						Diag.Dug(ex);
						throw ex;
					}
			...
			if (updatingArgs != null && updatingArgs.Status == UpdateStatus.Continue)
			{
				...
				else if (updatedArgs.Status == UpdateStatus.ErrorsOccurred)
				{
					if (updatingArgs.Errors == null)
					{
						Diag.Dug(true, "RowUpdatedEvent: Errors occurred; no additional information available.");
	...
	{
		return BlackbirdSql.Data.Common.TypeHelper.IsDBNull(value);
	}
