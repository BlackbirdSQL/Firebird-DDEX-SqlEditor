...
internal sealed class DslEnlistmentNotification : IEnlistmentNotification
{
	#region Events
	...
	public DslEnlistmentNotification(DslConnectionInternal connection, Transaction systemTransaction)
	{
	...
	{
		Diag.Dug(true, "In Doubt transactions are not supported");
