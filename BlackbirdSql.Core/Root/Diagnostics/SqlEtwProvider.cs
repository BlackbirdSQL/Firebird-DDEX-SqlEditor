...
internal static class SqlEtwProvider
{
	...
	{
		return m_provider.IsEnabled();
	}

	public static bool IsEnabled(byte level, long keywords)
	{
		return m_provider.IsEnabled(level, keywords);
	}

	public static bool IsLoggingEnabled(EnWinEventTracingLevel level)
	{
		return m_provider.IsEnabled((byte)level, LogCritical.Keywords);
	}

	static SqlEtwProvider()
	{
		m_provider = new EventProviderVersionTwo(new Guid(SystemData.EventProviderGuid));
	...
	public static bool EventWriteSchemaCompare(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref SchemaCompare, IsStart, EventContext);
	}

	public static bool EventWriteSchemaCompareError(string message)
	{
		return m_provider.WriteEvent(ref SchemaCompareError, message);
	}
	...
	public static bool EventWriteSqlEditorExecute(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref SqlEditorExecute, IsStart, EventContext);
	}
	...
	public static bool EventWriteProjectLoad(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref ProjectLoad, IsStart, EventContext);
	}
	...
	public static bool EventWriteProjectOpen(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref ProjectOpen, IsStart, EventContext);
	}
	...
	public static bool EventWriteProjectWizardImportSchemaFinish(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref ProjectWizardImportSchemaFinish, IsStart, EventContext);
	}
	...
	public static bool EventWriteProjectBuild(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref ProjectBuild, IsStart, EventContext);
	}

	public static bool EventWriteProjectBuildError(string message)
	{
		return m_provider.WriteEvent(ref ProjectBuildError, message);
	}
	...
	public static bool EventWriteProjectDeploy(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref ProjectDeploy, IsStart, EventContext);
	}
	...
	public static bool EventWriteDisplayAdapterSchemaObjectChangeDone(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref DisplayAdapterSchemaObjectChangeDone, IsStart, EventContext);
	}
	...
	public static bool EventWriteSchemaViewNodePopulationComplete(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref SchemaViewNodePopulationComplete, IsStart, EventContext);
	}
	...
	public static bool EventWriteConnectionStringPersistedInRegistry(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref ConnectionStringPersistedInRegistry, IsStart, EventContext);
	}
	...
	public static bool EventWriteDataSchemaModelRecycle(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref DataSchemaModelRecycle, IsStart, EventContext);
	}
	...
	public static bool EventWriteImportSchema(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref ImportSchema, IsStart, EventContext);
	}
	...
	public static bool EventWriteImportSchemaFinish(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref ImportSchemaFinish, IsStart, EventContext);
	}

	public static bool EventWriteImportSchemaFinishError(string message)
	{
		return m_provider.WriteEvent(ref ImportSchemaFinishError, message);
	}
	...
	public static bool EventWriteImportSchemaGenerateAllScripts(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref ImportSchemaGenerateAllScripts, IsStart, EventContext);
	}
	...
	public static bool EventWriteImportSchemaGenerateSingleScript(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref ImportSchemaGenerateSingleScript, IsStart, EventContext);
	}
	...
	public static bool EventWriteImportSchemaAddAllScriptsToProject(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref ImportSchemaAddAllScriptsToProject, IsStart, EventContext);
	}
	...
	public static bool EventWriteImportSchemaAddSingleScriptToProject(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref ImportSchemaAddSingleScriptToProject, IsStart, EventContext);
	}
	...
	public static bool EventWriteImportSchemaGenerateProjectMapForType(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref ImportSchemaGenerateProjectMapForType, IsStart, EventContext);
	}
	...
	public static bool EventWriteImportSchemaGenerateProjectMapForElement(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref ImportSchemaGenerateProjectMapForElement, IsStart, EventContext);
	}
	...
	public static bool EventWriteImportSchemaAddScriptsToProjectForType(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref ImportSchemaAddScriptsToProjectForType, IsStart, EventContext);
	}
	...
	public static bool EventWriteImportScript(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref ImportScript, IsStart, EventContext);
	}
	...
	public static bool EventWriteModelCompare(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref ModelCompare, IsStart, EventContext);
	}
	...
	public static bool EventWriteCommit(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref Commit, IsStart);
	}
	...
	public static bool EventWriteLogCritical(uint traceId, string message)
	{
		...
		return m_provider.TemplateLoggingMessage(ref LogCritical, traceId, message);
	}
	...
	public static bool EventWriteLogError(uint traceId, string message)
	{
		...
		return m_provider.TemplateLoggingMessage(ref LogError, traceId, message);
	}
	...
	public static bool EventWriteLogWarning(uint traceId, string message)
	{
		...
		return m_provider.TemplateLoggingMessage(ref LogWarning, traceId, message);
	}
	...
	public static bool EventWriteLogInformational(uint traceId, string message)
	{
		...
		return m_provider.TemplateLoggingMessage(ref LogInformational, traceId, message);
	}
	...
	public static bool EventWriteLogVerbose(uint traceId, string message)
	{
		...
		return m_provider.TemplateLoggingMessage(ref LogVerbose, traceId, message);
	}
	...
	public static bool EventWriteTableDesignerUpdateContextView(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref TableDesignerUpdateContextView, IsStart);
	}
	...
	public static bool EventWriteTableDesignerAddNewTable(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref TableDesignerAddNewTable, IsStart);
	}
	...
	public static bool EventWriteTableDesignerOpenTable(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref TableDesignerOpenTable, IsStart);
	}
	...
	public static bool EventWriteTableDesignerSpecifyTableProperties(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref TableDesignerSpecifyTableProperties, IsStart);
	}
	...
	public static bool EventWriteTableDesignerAddColumns(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref TableDesignerAddColumns, IsStart);
	}
	...
	public static bool EventWriteTableDesignerAddObjectFromCtxPane(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref TableDesignerAddObjectFromCtxPane, IsStart);
	}
	...
	public static bool EventWriteTableDesignerRefactorRename(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref TableDesignerRefactorRename, IsStart);
	}
	...
	public static bool EventWriteTableDesignerDeleteColumns(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref TableDesignerDeleteColumns, IsStart, EventContext);
	}
	...
	public static bool EventWriteSchemaCompareDataPopulationJob(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref SchemaCompareDataPopulationJob, IsStart, EventContext);
	}

	public static bool EventWriteSchemaCompareDataPopulationCancel(string message)
	{
		return m_provider.WriteEvent(ref SchemaCompareDataPopulationCancel, message);
	}
	...
	public static bool EventWriteSchemaCompareScriptPopulationJob(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref SchemaCompareScriptPopulationJob, IsStart, EventContext);
	}

	public static bool EventWriteSchemaCompareScriptPopulationCancel(string message)
	{
		return m_provider.WriteEvent(ref SchemaCompareScriptPopulationCancel, message);
	}
	...
	public static bool EventWriteSchemaCompareGetAndResolveDataSchemaModel(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref SchemaCompareGetAndResolveDataSchemaModel, IsStart, EventContext);
	}
	...
	public static bool EventWriteSchemaCompareModelCompare(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref SchemaCompareModelCompare, IsStart, EventContext);
	}
	...
	public static bool EventWriteSchemaCompareGenerateVisual(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref SchemaCompareGenerateVisual, IsStart, EventContext);
	}
	...
	public static bool EventWriteSchemaCompareUpdateTargetJob(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref SchemaCompareUpdateTargetJob, IsStart, EventContext);
	}

	public static bool EventWriteSchemaCompareUpdateTargetCancel(string message)
	{
		return m_provider.WriteEvent(ref SchemaCompareUpdateTargetCancel, message);
	}
	...
	public static bool EventWriteProjectSystemSnapshot(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref ProjectSystemSnapshot, IsStart);
	}
	...
	public static bool EventWriteProjectSystemSnapshotBuildFailed()
	{
		...
		return m_provider.TemplateEventDescriptor(ref ProjectSystemSnapshotBuildFailed);
	}
	...
	public static bool EventWriteProjectSystemPublishing(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref ProjectSystemPublishing, IsStart);
	}
	...
	public static bool EventWriteProjectSystemPublishCreateDeploymentPlan(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref ProjectSystemPublishCreateDeploymentPlan, IsStart);
	}
	...
	public static bool EventWriteProjectSystemPublishCreatePublishScripts(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref ProjectSystemPublishCreatePublishScripts, IsStart);
	}
	...
	public static bool EventWriteProjectSystemPublishShowScript(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref ProjectSystemPublishShowScript, IsStart);
	}
	...
	public static bool EventWriteProjectSystemPublishExecuteScript(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref ProjectSystemPublishExecuteScript, IsStart);
	}

	public static bool EventWriteProjectSystemPublishResults(string message)
	{
		return m_provider.WriteEvent(ref ProjectSystemPublishResults, message);
	}
	...
	public static bool EventWriteQueryResultExecuteQuery(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref QueryResultExecuteQuery, IsStart);
	}
	...
	public static bool EventWriteQueryResultCreateScript(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref QueryResultCreateScript, IsStart);
	}
	...
	public static bool EventWriteQueryResultsLoaded()
	{
		...
		return m_provider.TemplateEventDescriptor(ref QueryResultsLoaded);
	}
	...
	public static bool EventWriteProjectSystemImportSnapshot(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref ProjectSystemImportSnapshot, IsStart);
	}
	...
	public static bool EventWriteFileOpen(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref FileOpen, IsStart, EventContext);
	}
	...
	public static bool EventWriteLoadTSqlDocData(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref LoadTSqlDocData, IsStart, EventContext);
	}
	...
	public static bool EventWriteTSqlEditorFrameCreate(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref TSqlEditorFrameCreate, IsStart, EventContext);
	}
	...
	public static bool EventWriteTSqlEditorActivate(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref TSqlEditorActivate, IsStart, EventContext);
	}
	...
	public static bool EventWriteTSqlEditorTabSwitch(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref TSqlEditorTabSwitch, IsStart, EventContext);
	}
	...
	public static bool EventWriteTSqlEditorLaunch(bool IsStart, string EventContext)
	{
		...
		return m_provider.TemplateGenericBeginEndMessage(ref TSqlEditorLaunch, IsStart, EventContext);
	}

	public static bool EventWriteTSqlOnlineEditorDocumentLoad(string message)
	{
		return m_provider.WriteEvent(ref TSqlOnlineEditorDocumentLoad, message);
	}
	...
	public static bool EventWriteServerExplorerServerPropertiesRetrieved(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref ServerExplorerServerPropertiesRetrieved, IsStart);
	}
	...
	public static bool EventWriteGotoDefinition(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref GotoDefinition, IsStart);
	}
	...
	public static bool EventWriteFindAllReferences(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref FindAllReferences, IsStart);
	}
	...
	public static bool EventWriteRefactor(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref Refactor, IsStart);
	}
	...
	public static bool EventWriteRefactorContributeChanges(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref RefactorContributeChanges, IsStart);
	}
	...
	public static bool EventWriteRefactorApplyChanges(bool IsStart)
	{
		...
		return m_provider.TemplateEmptyBeginEndMessage(ref RefactorApplyChanges, IsStart);
	}
}
