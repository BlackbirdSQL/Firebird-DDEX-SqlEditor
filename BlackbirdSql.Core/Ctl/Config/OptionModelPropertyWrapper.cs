...
public class OptionModelPropertyWrapper : IBOptionModelPropertyWrapper
{
	//
	// Summary:
	...
	{
		Dictionary<EnNativeSettingsType, Action<WritableSettingsStore, string, string, object>> dictionary = (Dictionary<EnNativeSettingsType, Action<WritableSettingsStore, string, string, object>>)(SettingStoreSetMethodsDict = new Dictionary<EnNativeSettingsType, Action<WritableSettingsStore, string, string, object>>(7));
		Dictionary<EnNativeSettingsType, Func<SettingsStore, string, string, object>> dictionary2 = (Dictionary<EnNativeSettingsType, Func<SettingsStore, string, string, object>>)(SettingStoreGetMethodsDict = new Dictionary<EnNativeSettingsType, Func<SettingsStore, string, string, object>>(7));
		Type typeFromHandle = typeof(WritableSettingsStore);
		dictionary[EnNativeSettingsType.String] = CreateSettingsStoreSetMethod<string>(typeFromHandle.GetMethod("SetString", new Type[3]
		{
			typeof(string),
			typeof(string),
			typeof(string)
		}));
		dictionary[EnNativeSettingsType.Int32] = CreateSettingsStoreSetMethod<int>(typeFromHandle.GetMethod("SetInt32", new Type[3]
		{
			typeof(string),
			typeof(string),
			typeof(int)
		}));
		dictionary[EnNativeSettingsType.UInt32] = CreateSettingsStoreSetMethod<uint>(typeFromHandle.GetMethod("SetUInt32", new Type[3]
		{
			typeof(string),
			typeof(string),
			typeof(uint)
		}));
		dictionary[EnNativeSettingsType.Int64] = CreateSettingsStoreSetMethod<long>(typeFromHandle.GetMethod("SetInt64", new Type[3]
		{
			typeof(string),
			typeof(string),
			typeof(long)
		}));
		dictionary[EnNativeSettingsType.UInt64] = CreateSettingsStoreSetMethod<ulong>(typeFromHandle.GetMethod("SetUInt64", new Type[3]
		{
			typeof(string),
			typeof(string),
			typeof(ulong)
		}));
		dictionary[EnNativeSettingsType.Binary] = CreateSettingsStoreSetMethod<MemoryStream>(typeFromHandle.GetMethod("SetMemoryStream", new Type[3]
		{
			typeof(string),
			typeof(string),
			typeof(MemoryStream)
		...
		dictionary2[EnNativeSettingsType.String] = CreateSettingsStoreGetMethod<string>(typeFromHandle2.GetMethod("GetString", new Type[2]
		{
			typeof(string),
			typeof(string)
		}));
		dictionary2[EnNativeSettingsType.Int32] = CreateSettingsStoreGetMethod<int>(typeFromHandle2.GetMethod("GetInt32", new Type[2]
		{
			typeof(string),
			typeof(string)
		}));
		dictionary2[EnNativeSettingsType.UInt32] = CreateSettingsStoreGetMethod<uint>(typeFromHandle2.GetMethod("GetUInt32", new Type[2]
		{
			typeof(string),
			typeof(string)
		}));
		dictionary2[EnNativeSettingsType.Int64] = CreateSettingsStoreGetMethod<long>(typeFromHandle2.GetMethod("GetInt64", new Type[2]
		{
			typeof(string),
			typeof(string)
		}));
		dictionary2[EnNativeSettingsType.UInt64] = CreateSettingsStoreGetMethod<ulong>(typeFromHandle2.GetMethod("GetUInt64", new Type[2]
		{
			typeof(string),
			typeof(string)
		}));
		dictionary2[EnNativeSettingsType.Binary] = CreateSettingsStoreGetMethod<MemoryStream>(typeFromHandle2.GetMethod("GetMemoryStream", new Type[2]
		{
			typeof(string),
			typeof(string)
		}));
