...
public abstract class AbstractEnumConverter : EnumConverter
{
	...
	public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
	{
		...
		{
			AbstractGlobalizedDescriptionAttribute[] array = (AbstractGlobalizedDescriptionAttribute[])@enum.GetType().GetField(value.ToString()).GetCustomAttributes(typeof(AbstractGlobalizedDescriptionAttribute), inherit: false);
			if (array.Length != 0)
			{
