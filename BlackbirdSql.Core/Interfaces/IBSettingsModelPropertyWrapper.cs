...
public interface IBSettingsModelPropertyWrapper : IBsModelPropertyWrapper
{
	...
	bool Load<TOptMdl>(AbstractSettingsModel<TOptMdl> baseOptionModel, IBsSettingsProvider transientSettings) where TOptMdl : AbstractSettingsModel<TOptMdl>;
	...
	bool Save<TOptMdl>(AbstractSettingsModel<TOptMdl> baseOptionModel, IBsSettingsProvider liveSettings) where TOptMdl : AbstractSettingsModel<TOptMdl>;
}
