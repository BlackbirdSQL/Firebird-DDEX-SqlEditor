...
{
	private AbstractTransientSettingsDialog()
	{

	}


	public AbstractTransientSettingsDialog(Icon icon, Font font)
	{
		InitializeComponent();
		Icon = icon;
		Font = font;
	...
	protected IBsSettingsPage[] _OptionViews;
	...
	protected override void OnClosing(CancelEventArgs e)
	{
		...
		if (DialogResult == DialogResult.OK)
		{
			...
			{
				foreach (IBsSettingsPage page in _OptionViews)
				{
					page.SaveSettings();
				}
			}
	...
	protected void SetControls(IBsSettingsPage[] pages)
	{
		_OptionViews = pages;
