...
public static class CommandProperties
{
	...
	public static CommandID GlobalNewTrigger = new CommandID(new Guid(MenuGroupGuid), 12362);
	...
	public static CommandID NewTrigger = new CommandID(new Guid(MenuGroupGuid), 13607);
