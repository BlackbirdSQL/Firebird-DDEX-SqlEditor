...
static class ExtensionMembers
{
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "VSTHRD002:Avoid problematic synchronous waits", Justification = "For StartNew")]
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "VSTHRD002:Avoid problematic synchronous waits", Justification = "Task is done")]
	...
	public static bool ValidateKeys(this IVsDataConnectionProperties site)
	{
		...
		string derivedConnectionName = (dataSource != null && derivedDatasetId != null)
			? SysConstants.C_DatasetKeyFmt.FmtRes(dataSource, derivedDatasetId) : null;
		string derivedAlternateConnectionName = (dataSource != null && derivedDatasetId != null)
			? SysConstants.C_DatasetKeyAlternateFmt.FmtRes(dataSource, derivedDatasetId) : null;
