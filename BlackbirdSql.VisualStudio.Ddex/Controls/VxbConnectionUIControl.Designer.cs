...
{
	partial class VxbConnectionUIControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(VxbConnectionUIControl));
            ...
            resources.GetString("cboCharset.Items27"),
            resources.GetString("cboCharset.Items28"),
            resources.GetString("cboCharset.Items29"),
            resources.GetString("cboCharset.Items30"),
            resources.GetString("cboCharset.Items31"),
            resources.GetString("cboCharset.Items32"),
            resources.GetString("cboCharset.Items33"),
            resources.GetString("cboCharset.Items34"),
            resources.GetString("cboCharset.Items35"),
            resources.GetString("cboCharset.Items36"),
            resources.GetString("cboCharset.Items37"),
            resources.GetString("cboCharset.Items38"),
            resources.GetString("cboCharset.Items39"),
            resources.GetString("cboCharset.Items40"),
            resources.GetString("cboCharset.Items41"),
            resources.GetString("cboCharset.Items42"),
            resources.GetString("cboCharset.Items43"),
            resources.GetString("cboCharset.Items44"),
            resources.GetString("cboCharset.Items45"),
            resources.GetString("cboCharset.Items46"),
            resources.GetString("cboCharset.Items47"),
            resources.GetString("cboCharset.Items48"),
            resources.GetString("cboCharset.Items49"),
            resources.GetString("cboCharset.Items50"),
            resources.GetString("cboCharset.Items51"),
            resources.GetString("cboCharset.Items52")});
			...
			this.Name = "VxbConnectionUIControl";
