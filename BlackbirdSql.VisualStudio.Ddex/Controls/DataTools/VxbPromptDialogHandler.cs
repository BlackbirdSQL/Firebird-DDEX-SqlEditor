...
public class VxbPromptDialogHandler : IBsDataConnectionPromptDialogHandler
{
	public VxbPromptDialogHandler()
	{
	...
	{
		IVsDataConnectionPromptDialog connectionPromptDialog = new VxbConnectionPromptDialog();
