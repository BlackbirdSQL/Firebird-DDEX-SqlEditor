...
public partial class VxbConnectionDlg : Form, IBsDataConnectionDlg
{
	private class TiDataSourceCollection(VxbConnectionDlg dialog)
		: ICollection<TDataSource>, IEnumerable<TDataSource>, IEnumerable
	{
		private readonly List<TDataSource> _DataSources = [];

		private readonly VxbConnectionDlg _Dialog = dialog;
	...
	private class TiPropertyGridUIControl : UserControl, IDataConnectionUIControl
	{
		...
		private readonly BlackbirdSql.VisualStudio.Ddex.Controls.DataTools.VxbConnectionAdvancedDlg.TiSpecializedPropertyGrid propertyGrid;

		public TiPropertyGridUIControl()
		{
			propertyGrid = new VxbConnectionAdvancedDlg.TiSpecializedPropertyGrid();
			SuspendLayout();
	...
	public static DialogResult Show(VxbConnectionDlg dialog)
	{
		return Show(dialog, null);
	}

	public static DialogResult Show(VxbConnectionDlg dialog, IWin32Window owner)
	{
		if (dialog == null)
		{
	...
	{
		VxbConnectionAdvancedDlg dataConnectionAdvancedDlg = new (ConnectionProperties, this);
