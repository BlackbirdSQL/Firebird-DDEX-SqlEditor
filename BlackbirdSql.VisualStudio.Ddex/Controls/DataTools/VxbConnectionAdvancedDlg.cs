...
public partial class VxbConnectionAdvancedDlg : Form
{
	public class TiSpecializedPropertyGrid : PropertyGrid
	{
		...
		{
			VxbConnectionDlg dataConnectionDialog = base.ParentForm as VxbConnectionDlg;
			dataConnectionDialog ??= (base.ParentForm as VxbConnectionAdvancedDlg)._mainDialog;
			VxbAddPropertyDlg addPropertyDialog = new VxbAddPropertyDlg(dataConnectionDialog);
			try
			{
	...
	private readonly VxbConnectionDlg _mainDialog;

	private TiSpecializedPropertyGrid propertyGrid;

	public VxbConnectionAdvancedDlg()
	{
		InitializeComponent();
	...
	public VxbConnectionAdvancedDlg(IDataConnectionProperties connectionProperties, VxbConnectionDlg mainDialog)
		: this()
	{
