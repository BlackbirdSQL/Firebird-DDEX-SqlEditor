...
public sealed class DslDatabaseInfo
{
	#region Properties

	public DslConnection Connection { get; set; }
	...
	{
		return GetValue<string>(IscCodes.isc_info_blackbird_version);
	}
	public Task<string> GetServerVersionAsync(CancellationToken cancellationToken = default)
	{
		return GetValueAsync<string>(IscCodes.isc_info_blackbird_version, cancellationToken);
	}
	...
	public DslDatabaseInfo(DslConnection connection = null)
	{
	...
	{
		DslConnection.EnsureOpen(Connection);
