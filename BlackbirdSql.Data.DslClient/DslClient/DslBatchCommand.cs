...
public sealed class DslBatchCommand : IDslPreparedCommand, IDescriptorFiller, IDisposable
#if NET
		, IAsyncDisposable
#endif
{
	static readonly IFbLogger Log = FbLogManager.CreateLogger(nameof(DslBatchCommand));
	...
	private DslBatchParameterCollection _batchParameters;
	...
	public DslConnection Connection
	{
	...
	public DslBatchParameterCollection BatchParameters
	{
		get
		{
			_batchParameters ??= new DslBatchParameterCollection();
			return _batchParameters;
		}
	}

	public DslTransaction Transaction
	{
	...
	public DslBatchCommand()
		: this(null, null, null)
	{ }

	public DslBatchCommand(string cmdText)
		: this(cmdText, null, null)
	{ }

	public DslBatchCommand(string cmdText, DslConnection connection)
		: this(cmdText, connection, null)
	{ }

	public DslBatchCommand(string cmdText, DslConnection connection, DslTransaction transaction)
	{
	...
	public DslParameter CreateParameter()
	{
		return new DslParameter();
	}

	public DslParameterCollection AddBatchParameters()
	{
		var result = new DslParameterCollection();
	...
	public DslBatchNonQueryResult ExecuteNonQuery()
	{
		CheckCommand();

		DslBatchNonQueryResult result;
	...
	public async Task<DslBatchNonQueryResult> ExecuteNonQueryAsync(CancellationToken cancellationToken = default)
	{
		CheckCommand();
	...
	public int ComputeCurrentBatchSize()
	{
		if (_batch == null)
		{
			Diag.Dug(true, "Batch must be prepared.");
	...
	//			if (_activeReader != null)
	//			{
	//#if NETFRAMEWORK	//				_activeReader.Dispose();
	//#else
	...
	private DslBatchNonQueryResult ExecuteCommand(bool returnsSet)
	{
		...
		try
		{
			...
			// Execute
			return new DslBatchNonQueryResult(_batch.Execute(_batchParameters.Count, this));
		}
		finally
		{
			_batch.Release();
	...
	private async Task<DslBatchNonQueryResult> ExecuteCommandAsync(bool returnsSet, CancellationToken cancellationToken = default)
	{
		LogMessages.CommandExecution(Log, this);
		...
		try
		{
			...
			_batch.BatchBufferSize = BatchBufferSize;
			// Execute
			return new DslBatchNonQueryResult(await _batch.ExecuteAsync(_batchParameters.Count, this, cancellationToken).ConfigureAwait(false));
		}
		finally
		{
