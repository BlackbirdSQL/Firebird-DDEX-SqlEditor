	...
	private static byte FbShutdownOnlineModeToIscCode(FbShutdownOnlineMode mode)
	{
		...
		switch (mode)
		{
			case FbShutdownOnlineMode.Normal:
				retval = IscCodes.isc_spb_prp_sm_normal;
				break;
			case FbShutdownOnlineMode.Multi:
				retval = IscCodes.isc_spb_prp_sm_multi;
				break;
			case FbShutdownOnlineMode.Single:
				retval = IscCodes.isc_spb_prp_sm_single;
				break;
			case FbShutdownOnlineMode.Full:
				retval = IscCodes.isc_spb_prp_sm_full;
				break;
			default:
				ArgumentOutOfRangeException ex = new ArgumentOutOfRangeException(nameof(mode));
				Diag.Dug(ex);
				throw ex;
		}
