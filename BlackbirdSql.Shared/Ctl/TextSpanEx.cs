...
public class TextSpanEx : IBsTextSpan
{
	...
	public TextSpanEx(int anchorLine, int anchorCol, int endLine, int endCol, string text, IVsTextView vsTextView)
	{
	...
	public TextSpanEx(int anchorLine, int anchorCol, int endLine, int endCol, int offset, string text, IVsTextView vsTextView)
		: this(anchorLine, anchorCol, endLine, endCol, text, vsTextView)
	{
		_offset = offset;
	}

	public TextSpanEx(int anchorLine, int anchorCol, int endLine, int endCol, int offset, int lineWithinTextSpan, string text, IVsTextView vsTextView)
