...
public class QESQLBatchExecutionStartEventArgs : EventArgs
{
	...
	protected QESQLBatchExecutionStartEventArgs()
	{
	}

	public QESQLBatchExecutionStartEventArgs(int batchStartLineNum, QESQLBatch batch)
	{
