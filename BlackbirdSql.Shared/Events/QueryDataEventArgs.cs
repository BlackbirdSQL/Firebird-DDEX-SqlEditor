...
public delegate void QueryDataEventHandler(object sender, QueryDataEventArgs e);


public sealed class QueryDataEventArgs
{
	public QueryDataEventArgs(EnSqlExecutionType executionType,
