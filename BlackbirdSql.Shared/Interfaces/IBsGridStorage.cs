...
public interface IBsGridStorage
{
	long RowCount { get; }
	...
	void FillControlWithData(long nRowIndex, int nColIndex, IBsGridEmbeddedControl control);

	bool SetCellDataFromControl(long nRowIndex, int nColIndex, IBsGridEmbeddedControl control);
}
