...
public abstract class AbstruseEditorTab : IDisposable, IVsDesignerInfo, IVsMultiViewDocumentView,
	...
	public Panel ParentPanel
	{
		get
		{
			if (_ParentPanel == null)
			{
				...
				_ParentPanel.SizeChanged += ((AbstractEditorUIControl)Owner).Panel_SizeChanged;
			}
			return _ParentPanel;
		}
	}
