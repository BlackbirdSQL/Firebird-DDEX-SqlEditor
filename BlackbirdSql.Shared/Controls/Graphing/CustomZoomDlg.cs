...
#pragma warning restore CS0649 // Field 'FileEncodingDialog.components' is never assigned to, and will always have its default value null
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(BlackbirdSql.Shared.Controls.Graphing.CustomZoomDlg));
	...
	private void OnZoomClick(object sender, EventArgs e)
	{
		...
		catch (Exception ex)
		{
			...
			{
				MessageBoxCtl exceptionMessageBox = new(new ApplicationException(string.Format(ControlsResources.ZoomLevelShouldBeBetween, (int)zoomNumber.Minimum, (int)zoomNumber.Maximum)))
				{
