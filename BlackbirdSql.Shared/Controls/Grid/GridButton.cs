...
// Microsoft.SqlServer.Management.UI.Grid.GridButton
...
public sealed class GridButton
{
	...
	public Brush TextBrush
	{
		...
		set
		{
			...
			try
			{
				SolidBrush solidBrush = value as SolidBrush ?? throw new ArgumentException(ControlsResources.ExOnlySolidBrush, "value");
