...
// Microsoft.SqlServer.Management.UI.Grid.GridButtonColumn
...
public class GridButtonColumn : GridTextColumn
{
	...
	public override string GetAccessibleValue(long nRowIndex, IBsGridStorage storage)
	{
	...
	protected void DrawCellCommon(Graphics g, Brush bkBrush, Brush textBrush, Font textFont, Rectangle rect, IBsGridStorage storage, long nRowIndex, bool bEnabled)
	{
		DrawCellCommon(g, bkBrush, (SolidBrush)textBrush, textFont, rect, storage, nRowIndex, bEnabled);
	}

	protected void DrawCellCommon(Graphics g, Brush bkBrush, SolidBrush textBrush, Font textFont, Rectangle rect, IBsGridStorage storage, long nRowIndex, bool bEnabled)
	{
